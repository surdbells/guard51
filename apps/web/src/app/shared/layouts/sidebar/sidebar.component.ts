  ...
  private readonly allSections: NavSection[] = [
    {
      ...
      items: [
        ...
        { label: 'Guards', translateKey: 'nav.guards', icon: Shield, route: '/guards', moduleKey: 'guard_management', roles: ['company_admin', 'supervisor'] },
        { label: 'Clients', translateKey: 'nav.clients', icon: Building2, route: '/clients', moduleKey: 'client_management', roles: ['company_admin'] },
        { label: 'Sites', translateKey: 'nav.sites', icon: MapPin, route: '/sites', moduleKey: 'site_management', roles: ['company_admin', 'supervisor'] },
      ],
    },
    {
      label: 'Operations', translateKey: 'nav_sections.operations',
      items: [
        { label: 'Scheduling', translateKey: 'nav.scheduling', icon: Calendar, route: '/scheduling', moduleKey: 'scheduling', roles: ['company_admin', 'supervisor'] },
        { label: 'Attendance', translateKey: 'nav.attendance', icon: Clock, route: '/attendance', moduleKey: 'time_clock', roles: ['company_admin', 'supervisor'] },
        { label: 'Live Tracker', translateKey: 'nav.tracker', icon: Navigation, route: '/tracker', moduleKey: 'live_tracker', roles: ['company_admin', 'supervisor', 'dispatcher'] },
        { label: 'Site Tours', translateKey: 'nav.tours', icon: Route, route: '/tours', moduleKey: 'guard_tour', roles: ['company_admin', 'supervisor'] },
        { label: 'Reports', translateKey: 'nav.reports', icon: FileText, route: '/reports', moduleKey: 'daily_activity_report', roles: ['company_admin', 'supervisor', 'guard'] },
    ...
    },
    {
      ...
      items: [
        { label: 'Invoices', translateKey: 'nav.invoices', icon: Receipt, route: '/invoices', moduleKey: 'invoicing', roles: ['company_admin'] },
        { label: 'Payroll', translateKey: 'nav.payroll', icon: Wallet, route: '/payroll', moduleKey: 'payroll', roles: ['company_admin'] },
      ],
    },
    {
