...
final class Version20260327000002_TrackingToursPanic extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gl_tenant ON guard_locations (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gl_guard ON guard_locations (guard_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gl_recorded ON guard_locations (recorded_at)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gl_guard_time ON guard_locations (guard_id, recorded_at DESC)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ga_tenant ON geofence_alerts (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ga_guard ON geofence_alerts (guard_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ia_tenant ON idle_alerts (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ia_guard ON idle_alerts (guard_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_tcp_tenant ON tour_checkpoints (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_tcp_site ON tour_checkpoints (site_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ts_tenant ON tour_sessions (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ts_guard ON tour_sessions (guard_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ts_site ON tour_sessions (site_id)');

        // ── Tour Checkpoint Scans ──
        $this->addSql("
            CREATE TABLE IF NOT EXISTS tour_checkpoint_scans (
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_tcs_session ON tour_checkpoint_scans (session_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_pa_tenant ON panic_alerts (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_pa_status ON panic_alerts (status)');
    }
