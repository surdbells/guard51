...
final class Version20260328000001_FinanceBilling extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql("CREATE TABLE invoices (
            ...
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_inv_tenant ON invoices (tenant_id)');
        $this->addSql('CREATE INDEX idx_inv_client ON invoices (client_id)');
        $this->addSql('CREATE INDEX idx_inv_status ON invoices (status)');
        ...
        $this->addSql('CREATE INDEX idx_ii_invoice ON invoice_items (invoice_id)');
        ...
        $this->addSql("CREATE TABLE invoice_payments (
            id VARCHAR(36) NOT NULL, invoice_id VARCHAR(36) NOT NULL,
        ...
        $this->addSql('CREATE INDEX idx_ip_invoice ON invoice_payments (invoice_id)');
        ...
        $this->addSql('CREATE INDEX idx_pi_guard ON payroll_items (guard_id)');
        ...
        $this->addSql("CREATE TABLE pay_rate_multipliers (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL,
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL,
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_prm_tenant ON pay_rate_multipliers (tenant_id)');
        ...
        $this->addSql("CREATE TABLE payslips (
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_ps_guard ON payslips (guard_id)');
