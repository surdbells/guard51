...
final class Version20260328000004_AdvancedFeatures extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE IF NOT EXISTS guard_licenses (
            ...
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gl_tenant ON guard_licenses (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gl_guard ON guard_licenses (guard_id)');

        $this->addSql("CREATE TABLE IF NOT EXISTS two_factor_secrets (
        ...
        $this->addSql("CREATE TABLE IF NOT EXISTS audit_logs (
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL,
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_al_tenant ON audit_logs (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_al_user ON audit_logs (user_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_al_action ON audit_logs (action)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_al_created ON audit_logs (created_at)');

        $this->addSql("CREATE TABLE IF NOT EXISTS guard_performance_index (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL, guard_id VARCHAR(36) NOT NULL,
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL,
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gpi_tenant ON guard_performance_index (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_gpi_guard ON guard_performance_index (guard_id)');

        $this->addSql("CREATE TABLE IF NOT EXISTS properties (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL,
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL,
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_prop_tenant ON properties (tenant_id)');
    }
