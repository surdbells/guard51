...
final class Version20260328000003_OperationsExtended extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE patrol_vehicles (
        ...
        $this->addSql('CREATE INDEX idx_pv_tenant ON patrol_vehicles (tenant_id)');

        $this->addSql("CREATE TABLE vehicle_patrol_routes (
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_vpr_tenant ON vehicle_patrol_routes (tenant_id)');

        $this->addSql("CREATE TABLE vehicle_patrol_hits (
        ...
        $this->addSql('CREATE INDEX idx_vph_tenant ON vehicle_patrol_hits (tenant_id)');
        $this->addSql('CREATE INDEX idx_vph_route ON vehicle_patrol_hits (route_id)');
        ...
        $this->addSql('CREATE INDEX idx_vis_tenant ON visitors (tenant_id)');
        $this->addSql('CREATE INDEX idx_vis_site ON visitors (site_id)');

        $this->addSql("CREATE TABLE visitor_vehicles (
        ...
        $this->addSql('CREATE INDEX idx_vv_visitor ON visitor_vehicles (visitor_id)');

        $this->addSql("CREATE TABLE parking_areas (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL, site_id VARCHAR(36) NOT NULL,
            name VARCHAR(200) NOT NULL, total_spaces INT NOT NULL, status VARCHAR(10) NOT NULL DEFAULT 'active',
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_pa_tenant ON parking_areas (tenant_id)');

        $this->addSql("CREATE TABLE parking_lots (
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_pl_area ON parking_lots (parking_area_id)');
        ...
        $this->addSql("CREATE TABLE parking_vehicles (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL, site_id VARCHAR(36) NOT NULL,
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_pkv_tenant ON parking_vehicles (tenant_id)');
        $this->addSql('CREATE INDEX idx_pkv_site ON parking_vehicles (site_id)');

        $this->addSql("CREATE TABLE parking_incident_types (
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_pit_tenant ON parking_incident_types (tenant_id)');

        $this->addSql("CREATE TABLE parking_incidents (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL, site_id VARCHAR(36) NOT NULL,
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_pki_tenant ON parking_incidents (tenant_id)');
    }
