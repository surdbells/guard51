...
final class Version20260328000002_ClientChatNotifications extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE client_users (
        ...
        $this->addSql('CREATE INDEX idx_cu_tenant ON client_users (tenant_id)');
        $this->addSql('CREATE INDEX idx_cu_client ON client_users (client_id)');

        $this->addSql("CREATE TABLE chat_conversations (
            id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL,
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL,
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_cc_tenant ON chat_conversations (tenant_id)');
        ...
        $this->addSql("CREATE TABLE chat_participants (
            ...
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_cp_conv ON chat_participants (conversation_id)');
        $this->addSql('CREATE INDEX idx_cp_user ON chat_participants (user_id)');
        ...
        $this->addSql("CREATE TABLE chat_messages (
            ...
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_cm_conv ON chat_messages (conversation_id)');
        $this->addSql('CREATE INDEX idx_cm_sender ON chat_messages (sender_id)');
        ...
        $this->addSql('CREATE INDEX idx_notif_tenant ON notifications (tenant_id)');
        ...
        $this->addSql("CREATE TABLE device_tokens (
            ...
            created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL,
            PRIMARY KEY (id))");
        $this->addSql('CREATE INDEX idx_dt_user ON device_tokens (user_id)');
    }
