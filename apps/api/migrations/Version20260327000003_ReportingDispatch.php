...
final class Version20260327000003_ReportingDispatch extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_dar_tenant ON daily_activity_reports (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_dar_guard ON daily_activity_reports (guard_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_dar_date ON daily_activity_reports (report_date)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_crt_tenant ON custom_report_templates (tenant_id)');

        // ── Custom Report Submissions ──
        $this->addSql("
            CREATE TABLE IF NOT EXISTS custom_report_submissions (
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_crs_tenant ON custom_report_submissions (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_crs_template ON custom_report_submissions (template_id)');
        ...
        // ── Watch Mode Logs ──
        $this->addSql("
            CREATE TABLE IF NOT EXISTS watch_mode_logs (
                id VARCHAR(36) NOT NULL, tenant_id VARCHAR(36) NOT NULL,
                guard_id VARCHAR(36) NOT NULL, site_id VARCHAR(36) NOT NULL,
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_wml_tenant ON watch_mode_logs (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_wml_site ON watch_mode_logs (site_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ir_tenant ON incident_reports (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ir_site ON incident_reports (site_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ir_status ON incident_reports (status)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_ie_incident ON incident_escalations (incident_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_dc_tenant ON dispatch_calls (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_dc_status ON dispatch_calls (status)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_da_dispatch ON dispatch_assignments (dispatch_id)');
        ...
        ");
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_task_tenant ON tasks (tenant_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_task_site ON tasks (site_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_task_guard ON tasks (assigned_to)');
