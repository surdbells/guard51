...
class ChatConversationRepository extends BaseRepository
{
    ...
    public function findSiteChannel(string $tenantId, string $siteId): ?ChatConversation { return $this->findOneBy(['tenantId' => $tenantId, 'siteId' => $siteId, 'type' => 'site_channel']); }
}
